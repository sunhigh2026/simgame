...
const DATA = {
  ...
  // 顧客名ランダム生成用パーツ
  CLIENT_PREFIXES: [
    'あおい', 'さくら', 'ひまわり', 'もみじ', 'こまち', 'みずほ', 'やよい',
    'かすみ', 'なでしこ', 'ふじ', 'いちご', 'はるか', 'きらら', 'ことね',
    'アオイ', 'サクラ', 'フジ', 'ミナト', 'カスミ', 'ハナ',
    '東', '西', '南', '北', '中央', '新', '大', '第一', '第二',
  ],
  CLIENT_SUFFIXES: [
    '商事', 'コーポレーション', '工業', '不動産', '食品', '出版', '物流',
    '建設', '電機', '薬局', '商会', '書房', 'インターナショナル',
    '美容室', '整骨院', '保育園', '旅館', '呉服店', 'カフェ', '医院',
    'システム', 'デザイン', 'テック', 'クリエイティブ', 'ソリューションズ',
  ],
  CLIENT_NAMES: [
